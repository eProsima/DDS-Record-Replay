...
{
    /**
     * @brief Constructor for \c McapHandlerConfiguration.
     *
     ...
     *                                 not yet available.
     * @param buffer_size:             Max number of elements to keep in memory prior to writing in disk
     *                                 (applies to started state).
     * @param event_window:            Keep in memory samples received in time frame [s], to be stored when
     *                                 event triggered (applies to paused state).
     * @param cleanup_period:          Remove from buffer samples older than *now - event_window*
     *                                 with this period [s] (applies to paused state).
     * @param log_publishTime:         Whether to store messages with logTime set to sample publication timestamp.
     ...
     * @param mcap_writer_options:     Mcap writer configuration options.
