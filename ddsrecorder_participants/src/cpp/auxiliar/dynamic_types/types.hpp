...
ddsrouter::core::types::DdsTopic type_object_topic();

bool is_type_object_topic(const ddsrouter::core::types::DdsTopic& topic);

ddsrouter::core::types::Guid new_unique_guid();

std::unique_ptr<ddsrouter::core::types::DataReceived> string_serialization(
        std::shared_ptr<ddsrouter::core::PayloadPool> payload_pool,
        const std::string& str);

std::string string_deserialization(
        const std::unique_ptr<ddsrouter::core::types::DataReceived>& data);
