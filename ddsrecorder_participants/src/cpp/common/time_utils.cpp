        ...
        const std::string& time)
{
    ...
    std::chrono::time_point<std::chrono::system_clock> time_point = utils::string_to_timestamp(time.substr(0,
                    dot_pos),
    ...
    time_point =
            std::chrono::time_point_cast<utils::Timestamp::duration>(time_point + std::chrono::nanoseconds(
                        nanoseconds));
