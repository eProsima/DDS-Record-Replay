...
#include <cpp_utils/event/SignalManager.hpp>
    ...
    , callback_set_in_manager_(false)
{
    ...
    logDebug(UTILS_SIGNALHANDLER, "SignalEventHandler created for signal: " << SigVal << ".");
}
...
{
    unset_callback();
    logDebug(UTILS_SIGNALHANDLER, "SignalEventHandler destroyed for signal: " << SigVal << ".");
}
