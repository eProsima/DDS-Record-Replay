...
public:
     ...
     */
    CPP_UTILS_DllAPI PausableTimer(
            bool play) noexcept;
     ...
     */
    CPP_UTILS_DllAPI void play() noexcept;
     ...
     */
    CPP_UTILS_DllAPI void pause() noexcept;

    //! Elapsed time in milliseconds with object playing
    CPP_UTILS_DllAPI double elapsed() const noexcept override;
     ...
     */
    CPP_UTILS_DllAPI void reset() noexcept override;

    //! Whether the timer is playing or paused
    CPP_UTILS_DllAPI bool playing() const noexcept;
