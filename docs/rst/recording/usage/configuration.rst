...
.. list-table::
    ...
    *   - Include existing files
        - ``include-existing-files``
        - Whether the output files already present in the output directory are taken into account by the ``log-rotation``. See :ref:`Include Existing Files <recorder_usage_configuration_include_existing_files>`.
        - ``boolean``
        - ``false``
