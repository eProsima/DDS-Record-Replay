...
Feel free to review `this <https://github.com/eProsima/Fast-DDS/tree/v3.6.2/examples/cpp/xtypes>`_ section, where it is explained in detail how to configure a Fast DDS Publisher/Subscriber leveraging :term:`Dynamic Types<DynamicTypes>`.
