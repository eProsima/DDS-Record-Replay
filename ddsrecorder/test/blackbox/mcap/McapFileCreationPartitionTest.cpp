...
class McapFileCreationPartitionTest : public FileCreationPartitionTest
{
public:
    ...
    void TearDown() override
    {
        ...
        FileCreationPartitionTest::TearDown();
    }
 ...
 */
TEST_F(McapFileCreationPartitionTest, mcap_data_msgs_partition)
{
 ...
 */
TEST_F(McapFileCreationPartitionTest, mcap_dds_topic_partition)
{
    // adds the partition A in the publisher
    init_dds_data(std::vector<std::string>{"A"}, false);
 ...
 *  - Verify that the topic's type matches the recorded topic's type.
 */
TEST_F(McapFileCreationPartitionTest, mcap_ros2_topic_partition)
{
    // adds the partition A in the publisher
    init_dds_data(std::vector<std::string>{"A"}, false);
...
TEST_F(McapFileCreationPartitionTest, mcap_data_num_msgs_partition)
{
    // adds the partition A in the publisher
    init_dds_data(std::vector<std::string>{"A"}, false);
 ...
 */
TEST_F(McapFileCreationPartitionTest, transition_running_partition)
{
    // adds the partition A in the publisher
    init_dds_data(std::vector<std::string>{"A"}, false);
 ...
 *  - Verify that the message count matches the recorded message count.
 */
TEST_F(McapFileCreationPartitionTest, transition_paused_partition)
{
    // adds the partition A in the publisher
    init_dds_data(std::vector<std::string>{"A"}, false);
 ...
 *  - Verify that the message count matches the recorded message count.
 */
TEST_F(McapFileCreationPartitionTest, transition_suspended_partition)
{
    // adds the partition A in the publisher
    init_dds_data(std::vector<std::string>{"A"}, false);
 ...
 * - Verify that the message count matches the recorded message count.
 */
TEST_F(McapFileCreationPartitionTest, transition_stopped_partition)
{
    // adds the partition A in the publisher
    init_dds_data(std::vector<std::string>{"A"}, false);
 ...
 *  - Verify that the message count matches the recorded message count.
 */
TEST_F(McapFileCreationPartitionTest, transition_running_paused_partition)
{
    // adds the partition A in the publisher
    init_dds_data(std::vector<std::string>{"A"}, false);
 ...
 *  - Verify that the message count matches the recorded message count.
 */
TEST_F(McapFileCreationPartitionTest, transition_running_suspended_partition)
{
    // adds the partition A in the publisher
    init_dds_data(std::vector<std::string>{"A"}, false);
 ...
 *  - Verify that the message count matches the recorded message count.
 */
TEST_F(McapFileCreationPartitionTest, transition_running_stopped_partition)
{
    // adds the partition A in the publisher
    init_dds_data(std::vector<std::string>{"A"}, false);
 ...
 *  - Verify that the message count matches the recorded message count.
 */
TEST_F(McapFileCreationPartitionTest, transition_paused_running_partition)
{
    // adds the partition A in the publisher
    init_dds_data(std::vector<std::string>{"A"}, false);
 ...
 *  - Verify that the message count matches the recorded message count.
 */
TEST_F(McapFileCreationPartitionTest, transition_paused_suspended_partition)
{
    // adds the partition A in the publisher
    init_dds_data(std::vector<std::string>{"A"}, false);
 ...
 *  - Verify that the message count matches the recorded message count.
 */
TEST_F(McapFileCreationPartitionTest, transition_paused_stopped_partition)
{
    // adds the partition A in the publisher
    init_dds_data(std::vector<std::string>{"A"}, false);
 ...
 *  - Verify that the message count matches the recorded message count.
 */
TEST_F(McapFileCreationPartitionTest, transition_suspended_running_partition)
{
    // adds the partition A in the publisher
    init_dds_data(std::vector<std::string>{"A"}, false);
 ...
 *  - Verify that the message count matches the recorded message count.
 */
TEST_F(McapFileCreationPartitionTest, transition_suspended_paused_partition)
{
    // adds the partition A in the publisher
    init_dds_data(std::vector<std::string>{"A"}, false);
 ...
 *  - Verify that the message count matches the recorded message count.
 */
TEST_F(McapFileCreationPartitionTest, transition_suspended_stopped_partition)
{
    // adds the partition A in the publisher
    init_dds_data(std::vector<std::string>{"A"}, false);
 ...
 *  - Verify that the message count matches the recorded message count.
 */
TEST_F(McapFileCreationPartitionTest, transition_stopped_running_partition)
{
    // adds the partition A in the publisher
    init_dds_data(std::vector<std::string>{"A"}, false);
 ...
 *  - Verify that the message count matches the recorded message count.
 */
TEST_F(McapFileCreationPartitionTest, transition_stopped_paused_partition)
{
    // adds the partition A in the publisher
    init_dds_data(std::vector<std::string>{"A"}, false);
 ...
 *  - Verify that the message count matches the recorded message count.
 */
TEST_F(McapFileCreationPartitionTest, transition_stopped_suspended_partition)
{
    // adds the partition A in the publisher
    init_dds_data(std::vector<std::string>{"A"}, false);
 ...
 */
TEST_F(McapFileCreationPartitionTest, transition_paused_event_less_window_partition)
{
    // adds the partition A in the publisher
    init_dds_data(std::vector<std::string>{"A"}, false);
 ...
 *  - Verify that the oldest recorded message was recorded in the event window.
 */
TEST_F(McapFileCreationPartitionTest, transition_paused_event_max_window_partition)
{
    // adds the partition A in the publisher
    init_dds_data(std::vector<std::string>{"A"}, false);
 ...
 *  - Verify that the oldest recorded message was recorded in the event window.
 */
TEST_F(McapFileCreationPartitionTest, transition_paused_event_start_partition)
{
    // adds the partition A in the publisher
    init_dds_data(std::vector<std::string>{"A"}, false);
 ...
 *  - Verify that the oldest recorded message was recorded in the event window.
 */
TEST_F(McapFileCreationPartitionTest, transition_paused_event_suspend_partition)
{
    // adds the partition A in the publisher
    init_dds_data(std::vector<std::string>{"A"}, false);
 ...
 *  - Verify that the oldest recorded message was recorded in the event window.
 */
TEST_F(McapFileCreationPartitionTest, transition_paused_event_stop_partition)
{
    // adds the partition A in the publisher
    init_dds_data(std::vector<std::string>{"A"}, false);
 ...
 *  - Verify that the messages' sizes match the recorded data sizes.
 */
TEST_F(McapFileCreationPartitionTest, mcap_data_msgs_partition_no_record)
{
    // adds the partition A in the publisher
    init_dds_data(std::vector<std::string>{"A"}, false);
 ...
 *  - Verify that the topic's type matches the recorded topic's type.
 */
TEST_F(McapFileCreationPartitionTest, mcap_dds_topic_partition_no_record)
{
    // adds the partition A in the publisher
    init_dds_data(std::vector<std::string>{"A"}, false);
 ...
 *  - Verify that the topic's type matches the recorded topic's type.
 */
TEST_F(McapFileCreationPartitionTest, mcap_ros2_topic_partition_no_record)
{
    // adds the partition A in the publisher
    init_dds_data(std::vector<std::string>{"A"}, false);
 ...
 *  - Verify that the message count matches the recorded message count.
 */
TEST_F(McapFileCreationPartitionTest, transition_running_partition_no_record)
{
    // adds the partition A in the publisher
    init_dds_data(std::vector<std::string>{"A"}, false);
 ...
 *  - Verify that the message count matches the recorded message count.
 */
TEST_F(McapFileCreationPartitionTest, transition_paused_partition_no_record)
{
    // adds the partition A in the publisher
    init_dds_data(std::vector<std::string>{"A"}, false);
 ...
 *  - Verify that the message count matches the recorded message count.
 */
TEST_F(McapFileCreationPartitionTest, transition_suspended_partition_no_record)
{
    // adds the partition A in the publisher
    init_dds_data(std::vector<std::string>{"A"}, false);
 ...
 * - Verify that the message count matches the recorded message count.
 */
TEST_F(McapFileCreationPartitionTest, transition_stopped_partition_no_record)
{
    // adds the partition A in the publisher
    init_dds_data(std::vector<std::string>{"A"}, false);
 ...
 *  - Verify that the message count matches the recorded message count.
 */
TEST_F(McapFileCreationPartitionTest, transition_running_paused_partition_no_record)
{
    // adds the partition A in the publisher
    init_dds_data(std::vector<std::string>{"A"}, false);
 ...
 *  - Verify that the message count matches the recorded message count.
 */
TEST_F(McapFileCreationPartitionTest, transition_running_suspended_partition_no_record)
{
    // adds the partition A in the publisher
    init_dds_data(std::vector<std::string>{"A"}, false);
 ...
 *  - Verify that the message count matches the recorded message count.
 */
TEST_F(McapFileCreationPartitionTest, transition_running_stopped_partition_no_record)
{
    // adds the partition A in the publisher
    init_dds_data(std::vector<std::string>{"A"}, false);
 ...
 *  - Verify that the message count matches the recorded message count.
 */
TEST_F(McapFileCreationPartitionTest, transition_paused_running_partition_no_record)
{
    // adds the partition A in the publisher
    init_dds_data(std::vector<std::string>{"A"}, false);
 ...
 *  - Verify that the message count matches the recorded message count.
 */
TEST_F(McapFileCreationPartitionTest, transition_paused_suspended_partition_no_record)
{
    // adds the partition A in the publisher
    init_dds_data(std::vector<std::string>{"A"}, false);
 ...
 *  - Verify that the message count matches the recorded message count.
 */
TEST_F(McapFileCreationPartitionTest, transition_paused_stopped_partition_no_record)
{
    // adds the partition A in the publisher
    init_dds_data(std::vector<std::string>{"A"}, false);
 ...
 *  - Verify that the message count matches the recorded message count.
 */
TEST_F(McapFileCreationPartitionTest, transition_suspended_running_partition_no_record)
{
    // adds the partition A in the publisher
    init_dds_data(std::vector<std::string>{"A"}, false);
 ...
 *  - Verify that the message count matches the recorded message count.
 */
TEST_F(McapFileCreationPartitionTest, transition_suspended_paused_partition_no_record)
{
    // adds the partition A in the publisher
    init_dds_data(std::vector<std::string>{"A"}, false);
 ...
 *  - Verify that the message count matches the recorded message count.
 */
TEST_F(McapFileCreationPartitionTest, transition_suspended_stopped_partition_no_record)
{
    // adds the partition A in the publisher
    init_dds_data(std::vector<std::string>{"A"}, false);
 ...
 *  - Verify that the message count matches the recorded message count.
 */
TEST_F(McapFileCreationPartitionTest, transition_stopped_running_partition_no_record)
{
    // adds the partition A in the publisher
    init_dds_data(std::vector<std::string>{"A"}, false);
 ...
 *  - Verify that the message count matches the recorded message count.
 */
TEST_F(McapFileCreationPartitionTest, transition_stopped_paused_partition_no_record)
{
    // adds the partition A in the publisher
    init_dds_data(std::vector<std::string>{"A"}, false);
 ...
 *  - Verify that the message count matches the recorded message count.
 */
TEST_F(McapFileCreationPartitionTest, transition_stopped_suspended_partition_no_record)
{
    // adds the partition A in the publisher
    init_dds_data(std::vector<std::string>{"A"}, false);
 ...
 *  - Verify that the oldest recorded message was recorded in the event window.
 */
TEST_F(McapFileCreationPartitionTest, transition_paused_event_less_window_partition_no_record)
{
    // adds the partition A in the publisher
    init_dds_data(std::vector<std::string>{"A"}, false);
    ...
    // Record messages
    record_messages_(OUTPUT_FILE_NAME, NUMBER_OF_MESSAGES_1, STATE_1, NUMBER_OF_MESSAGES_2, STATE_2, WAIT, EVENT, "B");
 ...
 *  - Verify that the oldest recorded message was recorded in the event window.
 */
TEST_F(McapFileCreationPartitionTest, transition_paused_event_max_window_partition_no_record)
{
    // adds the partition A in the publisher
    init_dds_data(std::vector<std::string>{"A"}, false);
 ...
 *  - Verify that the oldest recorded message was recorded in the event window.
 */
TEST_F(McapFileCreationPartitionTest, transition_paused_event_start_partition_no_record)
{
    // adds the partition A in the publisher
    init_dds_data(std::vector<std::string>{"A"}, false);
 ...
 *  - Verify that the oldest recorded message was recorded in the event window.
 */
TEST_F(McapFileCreationPartitionTest, transition_paused_event_suspend_partition_no_record)
{
    // adds the partition A in the publisher
    init_dds_data(std::vector<std::string>{"A"}, false);
 ...
 *  - Verify that the oldest recorded message was recorded in the event window.
 */
TEST_F(McapFileCreationPartitionTest, transition_paused_event_stop_partition_no_record)
{
    // adds the partition A in the publisher
    init_dds_data(std::vector<std::string>{"A"}, false);
