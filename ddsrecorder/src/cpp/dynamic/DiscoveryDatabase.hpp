...
#ifndef __SRC_DDSRECORDER_DYNAMIC_DISCOVERYDATABASE_HPP_
#define __SRC_DDSRECORDER_DYNAMIC_DISCOVERYDATABASE_HPP_
...
#endif /* __SRC_DDSRECORDER_DYNAMIC_DISCOVERYDATABASE_HPP_ */
