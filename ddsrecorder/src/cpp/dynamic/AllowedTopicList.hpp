...
#ifndef __SRC_DDSRECORDER_DYNAMIC_ALLOWEDTOPICLIST_HPP_
#define __SRC_DDSRECORDER_DYNAMIC_ALLOWEDTOPICLIST_HPP_
...
#endif /* __SRC_DDSRECORDER_TOPIC_ALLOWEDTOPICLIST_HPP_ */
