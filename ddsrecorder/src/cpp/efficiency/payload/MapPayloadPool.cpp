        ...
        Payload& target_payload)
{
    ...
    else
    {
        ...
        {
            logError(DDSRECORDER_PAYLOADPOOL, "Payload ownership is this pool, but it is not reserved from here.");
        ...
        Payload& payload)
{
    ...
    if (payload_it == reserved_payloads_.end())
    {
        logError(DDSRECORDER_PAYLOADPOOL, "Trying to release a payload from this pool that is not present.");
