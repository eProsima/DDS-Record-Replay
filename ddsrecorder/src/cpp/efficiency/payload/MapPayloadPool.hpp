...
#ifndef __SRC_DDSRECORDER_EFFICIENCY_PAYLOAD_MAPPAYLOADPOOL_HPP_
#define __SRC_DDSRECORDER_EFFICIENCY_PAYLOAD_MAPPAYLOADPOOL_HPP_
...
#endif /* __SRC_DDSRECORDER_EFFICIENCY_PAYLOAD_MAPPAYLOADPOOL_HPP_ */
