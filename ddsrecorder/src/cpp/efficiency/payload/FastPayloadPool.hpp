...
#ifndef __SRC_DDSRECORDER_EFFICIENCY_PAYLOAD_FASTPAYLOADPOOL_HPP_
#define __SRC_DDSRECORDER_EFFICIENCY_PAYLOAD_FASTPAYLOADPOOL_HPP_
...
#endif /* __SRC_DDSRECORDER_EFFICIENCY_PAYLOAD_FASTPAYLOADPOOL_HPP_ */
