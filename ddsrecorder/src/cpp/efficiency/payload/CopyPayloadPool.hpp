...
#ifndef __SRC_DDSRECORDER_EFFICIENCY_PAYLOAD_COPYPAYLOADPOOL_HPP_
#define __SRC_DDSRECORDER_EFFICIENCY_PAYLOAD_COPYPAYLOADPOOL_HPP_
...
#endif /* __SRC_DDSRECORDER_EFFICIENCY_PAYLOAD_COPYPAYLOADPOOL_HPP_ */
