...
#ifndef __SRC_DDSRECORDER_EFFICIENCY_PAYLOAD_PAYLOADPOOL_HPP_
#define __SRC_DDSRECORDER_EFFICIENCY_PAYLOAD_PAYLOADPOOL_HPP_
...
#endif /* __SRC_DDSRECORDER_EFFICIENCY_PAYLOAD_PAYLOADPOOL_HPP_ */
