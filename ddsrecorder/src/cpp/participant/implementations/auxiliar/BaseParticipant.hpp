...
#ifndef __SRC_DDSRECORDER_PARTICIPANT_IMPLEMENTATIONS_AUXILIAR_BASEPARTICIPANT_HPP_
#define __SRC_DDSRECORDER_PARTICIPANT_IMPLEMENTATIONS_AUXILIAR_BASEPARTICIPANT_HPP_
...
public:
     ...
     * @param payload_pool DDS Recorder shared PayloadPool
     * @param discovery_database DDS Recorder shared Discovery Database
     */
    BaseParticipant(
...
protected:
    ...
    //! DDS Recorder shared Payload Pool
    std::shared_ptr<PayloadPool> payload_pool_;

    //! DDS Recorder shared Discovery Database
...
#endif /* __SRC_DDSRECORDER_PARTICIPANT_IMPLEMENTATIONS_AUXILIAR_BASEPARTICIPANT_HPP_ */
