...
#ifndef __SRC_DDSRECORDER_PARTICIPANT_IPARTICIPANT_HPP_
#define __SRC_DDSRECORDER_PARTICIPANT_IPARTICIPANT_HPP_
...
#endif /* __SRC_DDSRECORDER_PARTICIPANT_IPARTICIPANT_HPP_ */
