...
const option::Descriptor usage[] = {
    {
        ...
        Arg::None,
        "Usage: ddsrecorder \n" \
        "Record DDS traffic to MCAP and/or SQLite.\n" \
...

    {
        ...
        "./DDS_RECORDER_CONFIGURATION.yaml is loaded only if it exists."
    },
...

    {
        ...
        Arg::None,
        "  -d \t--debug\t  \t" \
        "Set log verbosity to info and use the DDSRECORDER category filter. " \
        ...
        yaml::CommandlineArgsRecorder& commandline_args)
{
    ...
    if (argc > 0)
    {
        ...
        {
            EPROSIMA_LOG_ERROR(DDSRECORDER_ARGS, "ERROR: Unknown argument: <" << parse.nonOption(0) << ">." );
            option::printUsage(fwrite, stdout, usage, columns);
            return ProcessReturnCode::incorrect_argument;
        }
        ...
        for (int i = 0; i < parse.optionsCount(); ++i)
        {
            ...
            switch (opt.index())
            {
                ...
                case optionIndex::UNKNOWN_OPT:
                    EPROSIMA_LOG_ERROR(DDSRECORDER_ARGS, opt << " is not a valid argument.");
                    option::printUsage(fwrite, stdout, usage, columns);
                    return ProcessReturnCode::incorrect_argument;
                    break;
        ...
        bool msg)
{
    ...
    if (msg)
    {
        EPROSIMA_LOG_ERROR(DDSRECORDER_ARGS, "Option '" << option << "' required.");
    }
    return option::ARG_ILLEGAL;
}
        ...
        bool msg)
{
    ...
    if (msg)
    {
        EPROSIMA_LOG_ERROR(DDSRECORDER_ARGS, "Option '" << option << "' requires a numeric argument.");
    }
    return option::ARG_ILLEGAL;
}
        ...
        bool msg)
{
    ...
    if (msg)
    {
        EPROSIMA_LOG_ERROR(DDSRECORDER_ARGS, "Option '" << option << "' requires a float argument.");
    }
    return option::ARG_ILLEGAL;
}
        ...
        bool msg)
{
    ...
    if (msg)
    {
        EPROSIMA_LOG_ERROR(DDSRECORDER_ARGS, "Option '" << option << "' requires a text argument.");
    }
    return option::ARG_ILLEGAL;
}
        ...
        bool msg)
{
    if (nullptr == option.arg)
    {
        if (msg)
        {
            EPROSIMA_LOG_ERROR(DDSRECORDER_ARGS, "Option '" << option.name << "' requires a text argument.");
        }
        return option::ARG_ILLEGAL;
    }
    ...
    else if (msg)
    {
        ...
        EPROSIMA_LOG_ERROR(DDSRECORDER_ARGS, error_msg);
    }
