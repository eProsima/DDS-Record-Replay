...
DDSBridge::DDSBridge(
    ...
    , topic_(topic)
{
    logDebug(DDSRECORDER_DDSBRIDGE, "Creating DDSBridge " << *this << ".");
    ...
    logDebug(DDSRECORDER_DDSBRIDGE, "DDSBridge " << *this << " created.");
}

DDSBridge::~DDSBridge()
{
    logDebug(DDSRECORDER_DDSBRIDGE, "Destroying DDSBridge " << *this << ".");
    ...
    logDebug(DDSRECORDER_DDSBRIDGE, "DDSBridge " << *this << " destroyed.");
}
...
void DDSBridge::enable() noexcept
{
    ...
    if (!enabled_)
    {
        logInfo(DDSRECORDER_DDSBRIDGE, "Enabling DDSBridge for topic " << topic_ << ".");
...
void DDSBridge::disable() noexcept
{
    ...
    if (enabled_)
    {
        logInfo(DDSRECORDER_DDSBRIDGE, "Disabling DDSBridge for topic " << topic_ << ".");
