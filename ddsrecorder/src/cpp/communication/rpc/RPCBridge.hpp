...
#ifndef __SRC_DDSRECORDER_COMMUNICATION_RPC_RPCBRIDGE_HPP_
#define __SRC_DDSRECORDER_COMMUNICATION_RPC_RPCBRIDGE_HPP_
...
public:
     ...
     * @param payload_pool: Payload Pool that handles the reservation/release of payloads throughout the DDS Recorder
...
#endif /* __SRC_DDSRECORDER_COMMUNICATION_RPC_RPCBRIDGE_HPP_ */
