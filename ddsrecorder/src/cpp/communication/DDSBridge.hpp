...
#ifndef __SRC_DDSRECORDER_COMMUNICATION_DDSBRIDGE_HPP_
#define __SRC_DDSRECORDER_COMMUNICATION_DDSBRIDGE_HPP_
...
#endif /* __SRC_DDSRECORDER_COMMUNICATION_DDSBRIDGE_HPP_ */
