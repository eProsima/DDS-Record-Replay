...
#ifndef __SRC_DDSRECORDER_CORE_DDS_ROUTERPARTICIPANTFACTORY_HPP_
#define __SRC_DDSRECORDER_CORE_DDS_ROUTERPARTICIPANTFACTORY_HPP_
...
#endif /* __SRC_DDSRECORDER_CORE_DDS_ROUTERPARTICIPANTFACTORY_HPP_ */
