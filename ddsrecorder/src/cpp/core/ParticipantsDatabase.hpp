...
#ifndef __SRC_DDSRECORDER_CORE_PARTICIPANTSDATABASE_HPP_
#define __SRC_DDSRECORDER_CORE_PARTICIPANTSDATABASE_HPP_
...
#endif /* __SRC_DDSRECORDER_CORE_PARTICIPANTSDATABASE_HPP_ */
