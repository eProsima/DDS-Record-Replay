...
#ifndef __SRC__SRC_DDSRECORDER_CORE_DDSRECORDERIMPL_HPP_
#define __SRC__SRC_DDSRECORDER_CORE_DDSRECORDERIMPL_HPP_
...
#include <ddsrecorder/types/endpoint/Endpoint.hpp>
...
#endif /* __SRC__SRC_DDSRECORDER_CORE_DDSRECORDERIMPL_HPP_ */
