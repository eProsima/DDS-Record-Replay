        ...
        bool client /* = false */) const
{
    ...
    if (client)
    {
        ...
        {
            logError(DDSRECORDER_DISCOVERYSERVER_PARTICIPANT,
    ...
    logDebug(DDSRECORDER_DISCOVERYSERVER_PARTICIPANT,
            "TLS configured.");
}
...
template <>
DDSRECORDER_DllAPI bool TlsConfiguration::is_valid_kind<TlsKind::client>(
...
template <>
DDSRECORDER_DllAPI bool TlsConfiguration::is_valid_kind<TlsKind::server>(
        utils::Formatter& error_msg) const noexcept
{
...
template <>
DDSRECORDER_DllAPI bool TlsConfiguration::is_valid_kind<TlsKind::both>(
        utils::Formatter& error_msg) const noexcept
{
