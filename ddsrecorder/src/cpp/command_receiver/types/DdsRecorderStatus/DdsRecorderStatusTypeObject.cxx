...
const TypeIdentifier* GetDdsRecorderStatusIdentifier(
        bool complete)
{
    const TypeIdentifier* c_identifier = TypeObjectFactory::get_instance()->get_type_identifier("DdsRecorderStatus",
                    complete);
...
const TypeObject* GetDdsRecorderStatusObject(
        bool complete)
{
