...
#define DdsRecorderStatus_max_cdr_typesize 780ULL;
#define DdsRecorderStatus_max_key_cdr_typesize 0ULL;
...
size_t DdsRecorderStatus::getMaxCdrSerializedSize(
        size_t current_alignment)
{
    static_cast<void>(current_alignment);
    return DdsRecorderStatus_max_cdr_typesize;
}

size_t DdsRecorderStatus::getCdrSerializedSize(
...
size_t DdsRecorderStatus::getKeyMaxCdrSerializedSize(
        size_t current_alignment)
{
    static_cast<void>(current_alignment);
    return DdsRecorderStatus_max_key_cdr_typesize;
}
...
void DdsRecorderStatus::serializeKey(
        eprosima::fastcdr::Cdr& scdr) const
{
    (void) scdr;
}
