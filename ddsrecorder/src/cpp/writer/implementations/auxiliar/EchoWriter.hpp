...
#ifndef __SRC_DDSRECORDER_WRITER_IMPLEMENTATIONS_AUXILIAR_ECHOWRITER_HPP_
#define __SRC_DDSRECORDER_WRITER_IMPLEMENTATIONS_AUXILIAR_ECHOWRITER_HPP_
...
#endif /* __SRC_DDSRECORDER_WRITER_IMPLEMENTATIONS_AUXILIAR_ECHOWRITER_HPP_ */
