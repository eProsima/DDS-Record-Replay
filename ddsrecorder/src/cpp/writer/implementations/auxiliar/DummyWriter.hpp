...
#ifndef __SRC_DDSRECORDER_WRITER_IMPLEMENTATIONS_AUXILIAR_DUMMYWRITER_HPP_
#define __SRC_DDSRECORDER_WRITER_IMPLEMENTATIONS_AUXILIAR_DUMMYWRITER_HPP_
...
#endif /* __SRC_DDSRECORDER_WRITER_IMPLEMENTATIONS_AUXILIAR_DUMMYWRITER_HPP_ */
