...
#ifndef __SRC_DDSRECORDER_WRITER_IMPLEMENTATIONS_AUXILIAR_VOIDWRITER_HPP_
#define __SRC_DDSRECORDER_WRITER_IMPLEMENTATIONS_AUXILIAR_VOIDWRITER_HPP_
...
#endif /* __SRC_DDSRECORDER_WRITER_IMPLEMENTATIONS_AUXILIAR_VOIDWRITER_HPP_ */
