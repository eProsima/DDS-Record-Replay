...
#ifndef __SRC_DDSRECORDER_WRITER_IMPLEMENTATIONS_AUXILIAR_BASEWRITER_HPP_
#define __SRC_DDSRECORDER_WRITER_IMPLEMENTATIONS_AUXILIAR_BASEWRITER_HPP_
...
#endif /* __SRC_DDSRECORDER_WRITER_IMPLEMENTATIONS_AUXILIAR_BASEWRITER_HPP_ */
