...
#ifndef __SRC_DDSRECORDER_PARTICIPANT_IMPLEMENTATIONS_RTPS_FILTER_REPEATERDATAFILTER_HPP_
#define __SRC_DDSRECORDER_PARTICIPANT_IMPLEMENTATIONS_RTPS_FILTER_REPEATERDATAFILTER_HPP_
 ...
 * (participants not belonging to the same DDS-Recorder instance),
...
#endif /* __SRC_DDSRECORDER_PARTICIPANT_IMPLEMENTATIONS_RTPS_FILTER_REPEATERDATAFILTER_HPP_ */
