...
#ifndef __SRC_DDSRECORDER_WRITER_IMPLEMENTATIONS_RTPS_PARTITIONSWRITER_HPP_
#define __SRC_DDSRECORDER_WRITER_IMPLEMENTATIONS_RTPS_PARTITIONSWRITER_HPP_
...
#endif /* __SRC_DDSRECORDER_WRITER_IMPLEMENTATIONS_RTPS_PARTITIONSWRITER_HPP_ */
