...
#ifndef __SRC_DDSRECORDER_WRITER_IMPLEMENTATIONS_RTPS_COMMONWRITER_HPP_
#define __SRC_DDSRECORDER_WRITER_IMPLEMENTATIONS_RTPS_COMMONWRITER_HPP_
...
#endif /* __SRC_DDSRECORDER_WRITER_IMPLEMENTATIONS_RTPS_COMMONWRITER_HPP_ */
