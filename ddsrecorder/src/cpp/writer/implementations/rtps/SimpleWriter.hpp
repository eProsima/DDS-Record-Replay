...
#ifndef __SRC_DDSRECORDER_WRITER_IMPLEMENTATIONS_RTPS_SIMPLEWRITER_HPP_
#define __SRC_DDSRECORDER_WRITER_IMPLEMENTATIONS_RTPS_SIMPLEWRITER_HPP_
...
#endif /* __SRC_DDSRECORDER_WRITER_IMPLEMENTATIONS_RTPS_SIMPLEWRITER_HPP_ */
