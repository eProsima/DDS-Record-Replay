...
#ifndef __SRC_DDSRECORDER_WRITER_IDDS_ROUTERWRITER_HPP_
#define __SRC_DDSRECORDER_WRITER_IDDS_ROUTERWRITER_HPP_
...
#endif /* __SRC_DDSRECORDER_WRITER_IDDS_ROUTERWRITER_HPP_ */
