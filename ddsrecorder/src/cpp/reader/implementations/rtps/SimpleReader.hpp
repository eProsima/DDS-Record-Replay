...
#ifndef __SRC_DDSRECORDER_READER_IMPLEMENTATIONS_RTPS_SIMPLEREADER_HPP_
#define __SRC_DDSRECORDER_READER_IMPLEMENTATIONS_RTPS_SIMPLEREADER_HPP_
...
#endif /* __SRC_DDSRECORDER_READER_IMPLEMENTATIONS_RTPS_SIMPLEREADER_HPP_ */
