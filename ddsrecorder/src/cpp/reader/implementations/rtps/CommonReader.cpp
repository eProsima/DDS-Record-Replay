...
CommonReader::~CommonReader()
{
    ...
    logInfo(DDSRECORDER_RTPS_READER, "Deleting CommonReader created in Participant " <<
        ...
        const fastrtps::ReaderQos& reader_qos)
{
    ...
    logInfo(DDSRECORDER_RTPS_READER, "New CommonReader created in Participant " << participant_id_ << " for topic " <<
        ...
        std::unique_ptr<DataReceived>& data) noexcept
{
    ...
    logDebug(DDSRECORDER_RTPS_COMMONREADER_LISTENER,
        ...
        const fastrtps::rtps::CacheChange_t* const change) noexcept
{
    ...
    {
        logWarning(
            DDSRECORDER_RTPS_COMMONREADER_LISTENER,
        ...
        fastrtps::rtps::MatchingInfo& info) noexcept
{
    if (!come_from_this_participant_(info.remoteEndpointGuid))
    {
        ...
        {
            logInfo(DDSRECORDER_RTPS_COMMONREADER_LISTENER,
        ...
        const fastrtps::rtps::CacheChange_t* received_change) const noexcept
{
    ...
    {
        logWarning(DDSRECORDER_RTPS_COMMONREADER_LISTENER,
