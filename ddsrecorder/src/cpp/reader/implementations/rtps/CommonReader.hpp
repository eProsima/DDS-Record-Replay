...
#ifndef __SRC_DDSRECORDER_READER_IMPLEMENTATIONS_RTPS_COMMONREADER_HPP_
#define __SRC_DDSRECORDER_READER_IMPLEMENTATIONS_RTPS_COMMONREADER_HPP_
...
#endif /* __SRC_DDSRECORDER_READER_IMPLEMENTATIONS_RTPS_COMMONREADER_HPP_ */
