...
#ifndef __SRC_DDSRECORDER_READER_IMPLEMENTATIONS_AUXILIAR_VOIDREADER_HPP_
#define __SRC_DDSRECORDER_READER_IMPLEMENTATIONS_AUXILIAR_VOIDREADER_HPP_
...
#endif /* __SRC_DDSRECORDER_READER_IMPLEMENTATIONS_AUXILIAR_VOIDREADER_HPP_ */
