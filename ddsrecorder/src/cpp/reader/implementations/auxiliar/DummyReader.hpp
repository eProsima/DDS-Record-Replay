...
#ifndef __SRC_DDSRECORDER_READER_IMPLEMENTATIONS_AUXILIAR_DUMMYREADER_HPP_
#define __SRC_DDSRECORDER_READER_IMPLEMENTATIONS_AUXILIAR_DUMMYREADER_HPP_
...
#endif /* __SRC_DDSRECORDER_READER_IMPLEMENTATIONS_AUXILIAR_DUMMYREADER_HPP_ */
