...
#ifndef __SRC_DDSRECORDER_READER_IDDS_ROUTERREADER_HPP_
#define __SRC_DDSRECORDER_READER_IDDS_ROUTERREADER_HPP_
...
public:
     ...
     * in a way that the payload in \c data must be inside the DDS Recorder PayloadPool.
...
#endif /* __SRC_DDSRECORDER_READER_IDDS_ROUTERREADER_HPP_ */
