...
#ifndef _DDSRECORDER_CORE_DDSRECORDER_HPP_
#define _DDSRECORDER_CORE_DDSRECORDER_HPP_
...
public:
     ...
     *
     * @param [in] configuration : Configuration for the new DDS Recorder
     *
    ...
    DDSRECORDER_DllAPI virtual ~DDSRouter();
     ...
     */
    DDSRECORDER_DllAPI utils::ReturnCode reload_configuration(
            const configuration::DDSRouterReloadConfiguration& configuration);

    /**
     * @brief Start communication in DDS Recorder
     *
     ...
     */
    DDSRECORDER_DllAPI utils::ReturnCode start() noexcept;

    /**
     * @brief Stop communication in DDS Recorder
     *
     ...
     * @return \c RETCODE_OK always
     */
    DDSRECORDER_DllAPI utils::ReturnCode stop() noexcept;

protected:

    std::unique_ptr<DDSRouterImpl> ddsrecorder_impl_;
};
...
#endif /* _DDSRECORDER_CORE_DDSRECORDER_HPP_ */
