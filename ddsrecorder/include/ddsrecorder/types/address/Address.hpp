...
#ifndef _DDSRECORDER_TYPES_ADDRESS_ADDRESS_HPP_
#define _DDSRECORDER_TYPES_ADDRESS_ADDRESS_HPP_
...
public:
    ...
    DDSRECORDER_DllAPI PortType port() const noexcept;
    //! Address external Port getter
    DDSRECORDER_DllAPI PortType external_port() const noexcept;
    //! Address IP getter
    DDSRECORDER_DllAPI IpType ip() const noexcept;
    //! Address IP version getter
    DDSRECORDER_DllAPI IpVersion ip_version() const noexcept;
    //! Address transport protocol version getter
    DDSRECORDER_DllAPI TransportProtocol transport_protocol() const noexcept;

    //! Whether transport is UDP
    DDSRECORDER_DllAPI bool is_udp() const noexcept;
    //! Whether transport is TCP
    DDSRECORDER_DllAPI bool is_tcp() const noexcept;

    //! Whether ip version is IpVersion::v4
    DDSRECORDER_DllAPI bool is_ipv4() const noexcept;
    //! Whether ip version is IpVersion::v6
    DDSRECORDER_DllAPI bool is_ipv6() const noexcept;

    //! Get FastDDS Locator kind
    DDSRECORDER_DllAPI LocatorType get_locator_kind() const noexcept;
     ...
     */
    DDSRECORDER_DllAPI static IpType resolve_dns(
            DomainType domain,
     ...
     * @throw DNSException in case an IP for this domain could not be retrieved
     */
    DDSRECORDER_DllAPI static std::pair<IpType, IpVersion> resolve_dns(
            DomainType domain);
...
#endif /* _DDSRECORDER_TYPES_ADDRESS_ADDRESS_HPP_ */
