...
#ifndef _DDSRECORDER_SECURITY_TLS_TLSCONFIGURATION_HPP_
#define _DDSRECORDER_SECURITY_TLS_TLSCONFIGURATION_HPP_
...
struct TlsConfiguration : public configuration::BaseConfiguration
{
     ...
     */
    DDSRECORDER_DllAPI TlsConfiguration() = default;

    /**
     * @brief Returns whether configuration is active
     */
    DDSRECORDER_DllAPI bool is_active() const noexcept;
    ...
    template <TlsKind Kind>
    DDSRECORDER_DllAPI bool is_valid_kind(
            utils::Formatter& error_msg) const noexcept;

    //! Activate TLS configuration in a TCP transport descriptor
    DDSRECORDER_DllAPI void enable_tls(
...
#endif /* _DDSRECORDER_SECURITY_TLS_TLSCONFIGURATION_HPP_ */
