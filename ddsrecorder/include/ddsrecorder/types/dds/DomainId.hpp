...
#ifndef _DDSRECORDER_TYPES_DDS_DOMAINID_HPP_
#define _DDSRECORDER_TYPES_DDS_DOMAINID_HPP_
...
public:
    ...
    /**
     * @brief Domain ID by default for DDS Recorders
     *
    ...
    DDSRECORDER_DllAPI DomainIdType operator ()() const noexcept;

    //! Return Fast DDS value for Domain ID
    DDSRECORDER_DllAPI DomainIdType domain_id() const noexcept;
    ...
    DDSRECORDER_DllAPI operator DomainIdType() const noexcept;
...
#endif /* _DDSRECORDER_TYPES_DDS_DOMAINID_HPP_ */
