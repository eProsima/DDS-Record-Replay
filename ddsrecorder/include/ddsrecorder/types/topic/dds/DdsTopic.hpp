...
#ifndef _DDSRECORDER_TYPES_TOPIC_DDS_DDSTOPIC_HPP_
#define _DDSRECORDER_TYPES_TOPIC_DDS_DDSTOPIC_HPP_
...
#include <ddsrecorder/types/topic/Topic.hpp>
...
struct DdsTopic : public Topic
{
    ...
    //! Default constructor
    DDSRECORDER_DllAPI DdsTopic() = default;

    //! Main values constructor
    DDSRECORDER_DllAPI DdsTopic(
    ...
    DDSRECORDER_DllAPI static bool is_valid_dds_topic(
            const std::string& topic_name,
            const std::string& type_name) noexcept;
...
#endif /* _DDSRECORDER_TYPES_TOPIC_DDS_DDSTOPIC_HPP_ */
