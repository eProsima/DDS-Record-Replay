...
#ifndef _DDSRECORDER_TYPES_PARTICIPANTKIND_HPP_
#define _DDSRECORDER_TYPES_PARTICIPANTKIND_HPP_
...
enum class ParticipantKind : ParticipantKindType
{
    ...
    dyn_type,                   //! TODO(recorder)
};

static constexpr unsigned PARTICIPANT_KIND_COUNT = 10;
...
constexpr std::array<ParticipantKindAliasesType, PARTICIPANT_KIND_COUNT> PARTICIPANT_KIND_ALIASES = {
    ...
    ParticipantKindAliasesType({"dynamic-types", "dyn-types", "types", ""}),
};
 ...
 */
DDSRECORDER_DllAPI ParticipantKind participant_kind_from_name(
...
#endif /* _DDSRECORDER_TYPES_PARTICIPANTKIND_HPP_ */
