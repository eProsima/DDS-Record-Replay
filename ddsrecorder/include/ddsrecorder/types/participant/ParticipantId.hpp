...
#ifndef _DDSRECORDER_TYPES_PARTICIPANTID_HPP_
#define _DDSRECORDER_TYPES_PARTICIPANTID_HPP_
...
public:
     ...
     */
    DDSRECORDER_DllAPI ParticipantId() noexcept;
     ...
     */
    DDSRECORDER_DllAPI ParticipantId(
     ...
     */
    DDSRECORDER_DllAPI std::string id_name() const noexcept;
     ...
     */
    DDSRECORDER_DllAPI static ParticipantId invalid() noexcept;
     ...
     */
    DDSRECORDER_DllAPI static bool is_valid_id(
            const std::string& id) noexcept;
...
protected:
    ...
    static const std::string INVALID_ID; // __invalid_DDSRECORDER_participant__
};
...
#endif /* _DDSRECORDER_TYPES_PARTICIPANTID_HPP_ */
