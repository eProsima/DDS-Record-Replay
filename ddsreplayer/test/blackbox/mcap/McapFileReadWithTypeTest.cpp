...
void create_subscriber_replayer(
        DataToCheck& data,
        const std::string& configuration_path = "/home/eprosima/FastDDS-Richi/src/DDS-Record-Replay/ddsreplayer/test/blackbox/mcap/resources/config_file.yaml",
        std::string input_file = "/home/eprosima/FastDDS-Richi/src/DDS-Record-Replay/ddsreplayer/test/blackbox/mcap/resources/helloworld_withtype_file.mcap",
        bool ros2 = false)
{
    {
