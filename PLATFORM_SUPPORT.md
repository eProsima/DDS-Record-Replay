...
This document reflects the level of support offered by *eprosima DDS Recorder* on different platforms as per the following
definitions:
...
The CI is expected to be run at least within a week of relevant changes for the current release of *DDS Recorder*.
