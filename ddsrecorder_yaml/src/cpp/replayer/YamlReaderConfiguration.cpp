        ...
        const YamlReaderVersion& version)
{
    ...
    {
        replayer_configuration->transport = YamlReader::get<TransportProtocol>(yml, ADDRESS_TRANSPORT_TAG, version);
    }
    else
    {
        replayer_configuration->transport = TransportProtocol::builtin;
    }
