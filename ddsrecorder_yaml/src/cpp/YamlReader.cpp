...
#include <ddsrecorder/configuration/participant/InitialPeersParticipantConfiguration.hpp>
        ...
        const YamlReaderVersion version)
{
    ...
    if (is_tag_present(yml, QOS_RELIABLE_TAG))
    {
        ...
        {
            object.reliability_qos = eprosima::ddsrecorder::core::types::ReliabilityKind::RELIABLE;
        }
        else
        {
            object.reliability_qos = eprosima::ddsrecorder::core::types::ReliabilityKind::BEST_EFFORT;
        }
    }
    ...
    if (is_tag_present(yml, QOS_TRANSIENT_TAG))
    {
        ...
        {
            object.durability_qos = eprosima::ddsrecorder::core::types::DurabilityKind::TRANSIENT_LOCAL;
        }
        else
        {
            object.durability_qos = eprosima::ddsrecorder::core::types::DurabilityKind::VOLATILE;
        }
    }
    ...
    if (is_tag_present(yml, QOS_OWNERSHIP_TAG))
    {
        ...
        {
            object.ownership_qos = eprosima::ddsrecorder::core::types::OwnershipQosPolicyKind::EXCLUSIVE_OWNERSHIP_QOS;
        }
        else
        {
            object.ownership_qos = eprosima::ddsrecorder::core::types::OwnershipQosPolicyKind::SHARED_OWNERSHIP_QOS;
        }
    }
}
